...
struct DistrictsOverviewView: View {
    ...
    private let states = ["All States", "Gujarat", "Maharashtra", "Karnataka", "Delhi", "West Bengal"]
        ...
        VStack(spacing: 16) {
            ...
            if filteredDistricts.isEmpty {
                EmptyStateView(
                    ...
                    description: districts.isEmpty ? "No districts in the system yet" : "Try adjusting your filters"
                )
            } else {
                ScrollView {
    ...
    private var filteredDistricts: [DistrictOverview] {
        ...
        if !searchText.isEmpty {
            result = result.filter {
                ...
                $0.districtHeadName.localizedCaseInsensitiveContains(searchText)
            }
        }
        ...
        VStack(alignment: .leading, spacing: 12) {
            ...
            HStack(spacing: 20) {
                ...
                DistrictMetricItem(
                    ...
                    label: "Revenue",
                    value: "₹\(String(format: "%.1f", Double(district.monthlyRevenue)/1000000))M"
                )
            }
