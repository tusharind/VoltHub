...
struct NewConnectionView: View {
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 24) {
                    VStack(alignment: .leading, spacing: 8) {
                        ...
                        Text("Fill in the details below to request a new electricity connection")
                            .font(.subheadline)
                    ...
                    VStack(alignment: .leading, spacing: 20) {
                        ...
                        HStack(alignment: .top, spacing: 12) {
                            ...
                            VStack(alignment: .leading, spacing: 4) {
                                ...
                                Text("Your connection request will be processed within 7-10 business days. You will receive updates via SMS and email.")
                                    .font(.caption)
                                    .foregroundColor(.secondary)
                            }
                        }
    ...
    private func handleSubmit() {
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + 1.5) {
            isSubmitting = false
            alertMessage = "Your connection request has been submitted successfully. You will receive a confirmation email shortly."
            showingAlert = true
        }
    }
}
